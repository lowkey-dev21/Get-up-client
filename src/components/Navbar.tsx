...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="z-[5000] top-0 fixed flex md:px-[5rem] px-[20px]  md:py-[2.5rem] w-full bg-[#25AD35] justify-between items-center h-[50px] md:h-[50px] ">
        {/* Logo */}
        ...
        {/* Mobile nav space */}
        {toggle && (
          <div className="bg-[#25ad3578] gap-6 text-xl justify-center  flex-col rounded-xl border shadow-2xl md:hidden fixed p-3 w-[200px] backdrop-blur-lg flex right-3 top-[50px] ">
            {navLinks.map((nav) => (
              <ul
