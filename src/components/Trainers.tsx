...
const Trainers = () => {
  ...
  return (
    <>
      <section className=" h-[400px] flex justify-center ">
        {/* desktop */}
        <div className=" grid-cols-3 gap-[2rem] justify-center items-center  sm:grid hidden  ">
          {trainers.map((trainer) => (
            <>
              ...
              >
                <img src={trainer.img} className=" object-cover  h-[300px] " alt="" />
        ...
        <div className="flex flex-col w-full gap-3  justify-center items-center md:hidden">
          <div className="flex items-center  justify-between w-full">
            ...
            <img
              ...
              className={`object-cover h-[250px] w-[260px] transition-all duration-300 ease-in-out ${
